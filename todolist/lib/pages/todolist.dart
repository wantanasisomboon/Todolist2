...
//function เพ่ื่อสั่งให้ run ทุกครั้งเวลาเปิด app ขึ้นมา
  @override
  void initState() {
  ...
  Future<void> getTodolists() async {
    List alltodo = [];
    var url = Uri.http('10.80.25.200:8000', '/api/all-todolist/');
    var response = await http.get(url); //คู่กับ async รอ request ให้
